class HablaYaApp {
    ...
    async getAIResponse(userMessage) {
        const systemMessage = {
            role: 'system',
            content: `You are HablaYa! - an advanced AI English tutor specializing in ${this.currentMode} practice.
            Current Settings:
            - User Level: ${this.userSettings.level}
            - Learning Focus: ${this.userSettings.focus}
            - Feedback Level: ${this.userSettings.feedbackLevel}
            - Current Mode: ${this.currentMode}
            
            Session Stats:
            - Words Practiced: ${this.sessionStats.wordsPracticed}
            - Messages Sent: ${this.sessionStats.messagesSent}
            - Average Accuracy: ${this.sessionStats.accuracyScore}%
            
            Provide personalized, encouraging responses that match the user's level and current learning mode.`
        };
    ...
    addPronunciationFeedback(analysis) {
        if (analysis.suggestions && analysis.suggestions.length > 0) {
            const feedbackMessage = `
                ...
                • Clarity: ${analysis.clarity}<br>
                • Pace: ${analysis.pace}<br>
    ...
    switchLearningMode(mode) {
        ...
        const modeMessages = {
            conversation: "Let's have a natural conversation! I'll help you practice everyday English.",
            pronunciation: "Focus on clear pronunciation. I'll provide detailed feedback on your speech.",
            grammar: "Let's work on grammar! I'll explain rules and correct any mistakes.",
            vocabulary: "Time to expand your vocabulary! I'll introduce new words and expressions."
        };
